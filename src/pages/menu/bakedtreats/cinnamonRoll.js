    ...
    render() {
        return(
            <main className="product-body">
                ...
                <article class="ProductItem greenbck cinna">
                     <section className="ImgWrap ImageWrap unicorn">
                                <img src={imageList.cinnamonRoll} className="carousel-item-image" id="cinnabon"></img>
                                <span className="ImgShadow greendayshadow" ></span>
                                  </section>  
                                  <section className="ProductInfo carousel-info roll">
                                    ...
                                    <p className="ProductDescrip item_description">Classic cinnamon. It’s beautiful and simple.</p>
                        ...
                        <Link id="moveLeft" className="slider__control" to="/menu/donuts/cocoaPeblets">
                        ...
                        <Link id="moveRight" className="slider__control slider__control__right" to ="/menu/bakedtreats/handpie">
